...
from helper import encode_data, send_mail
...
class EnterEmail(View):
    ...
    def post(self, request):
        ...
        signup_link = request.scheme + '://' + request.get_host() + '/accounts/signup/' + encoded_email + '/'

        # send encrypted signup link to user
        email_content = render_to_string(template_name=self.email, context={'signup_link': signup_link})
